...
with open(sys.argv[2], 'w', newline='') as f:
    out = csv.writer(f)
    out.writerow(['Comment', 'Designator', 'Footprint', 'LCSC Part #', 'Mounting'])
    ...
    for group in net.groupComponents():
        ...
        for component in group:
            ...
            lcsc_pn = component.getField("SourcingPartNum") or lcsc_pn
            mounting = component.getField("Mounting") or mounting
            c = component
        ...
        out.writerow([c.getValue() + " " + c.getDescription(), ",".join(refs), c.getFootprint().split(':')[1],lcsc_pn, mounting])
